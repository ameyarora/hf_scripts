...
// @require      https://raw.githubusercontent.com/ameyarora/hf_scripts/master/Lib/jquery.sticky.js
// @require      https://raw.githubusercontent.com/ameyarora/hf_scripts/master/Lib/GM_config.js
// @require      https://raw.githubusercontent.com/ameyarora/hf_scripts/master/Lib/jquery-ui.js
// @require      https://raw.githubusercontent.com/ameyarora/hf_scripts/master/Lib/tinybox.js
// @require      https://raw.githubusercontent.com/ameyarora/hf_scripts/master/Lib/jquery.textareafullscreen.js
// @match        *://hackforums.net*
// @match        *://hackforums.net/*
// @copyright    2020+
// @updateURL    https://github.com/ameyarora/hf_scripts/raw/master/Hack%20Forums%20Toolbar.user.js
// @downloadURL  https://github.com/ameyarora/hf_scripts/raw/master/Hack%20Forums%20Toolbar.user.js
// @grant        GM_getValue
// @grant        GM_setValue
// @grant        GM_log
// @grant        GM_info
...
var configSettings = {
    'showShortcut1':{
        ...
        'section': ['Shortcuts',"Shortcuts located on the left of Toolbar."],
        'type':'checkbox',
        'default':true,
    },
    'shortcut1Link':{
    ...
    'showNewPosts':{
        ...
        'section': ['Shortcuts',"Shortcuts located on the right of Toolbar."],
        'type':'checkbox',
        'default':true,
    },
    'showYourThreads':{
    ...
    'showIconLabels':{
        ...
        'section': ['Toolbar Utilities',"Customize the appearance of toolbar."],
        'type':'checkbox',
        'default':false,
    },
    'iconLabelSpacer':{
        'label':'Label Spacer:',
        'title':'Spacer between icons/labels in the toolbar.',
        'type':'select',
        'options':{
            'default':'-',
            'pipe':'|',
    ...
    'enableCurrentPageColor':{
        ...
        'title':"If you are on one of the toolbar links, it will color that icon.",
        'type':'checkbox',
        'default':true,
    },
    ...
    'HFTBversion':{
        'title':'About HF Toolbar',
        'section': ["About HF Toolbar",
...
$("head").append('<link '+ "href='https:\/\/raw.githubusercontent.com\/ameyarora\/hf_scripts\/master\/Lib\/textareafullscreen.css'" + 'rel="stylesheet" type="text/css">');
// Create toolbar
createStickyHeader();
// Stick toolbar
stickStickyHeader();
